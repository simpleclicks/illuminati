 ...
 * @see edu.pojo.Instructor
 * @author Hibernate Tools
 */
public class InstructorHome {

    private static final Log log = LogFactory.getLog(InstructorHome.class);
    ...
    public List findByExample(Instructor instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("edu.pojo.Instructor")
