package edu.pojo;
// Generated 16 Apr, 2013 10:54:12 PM by Hibernate Tools 3.1.0.beta4
 ...
 * @see edu.pojo.Courseinstructormap
 * @author Hibernate Tools
 */
public class CourseinstructormapHome {

    private static final Log log = LogFactory.getLog(CourseinstructormapHome.class);
    ...
    public Courseinstructormap findById( int id) {
        ...
        try {
            Courseinstructormap instance = (Courseinstructormap) sessionFactory.getCurrentSession()
                    .get("edu.pojo.Courseinstructormap", id);
            if (instance==null) {
    ...
    public List findByExample(Courseinstructormap instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("edu.pojo.Courseinstructormap")
