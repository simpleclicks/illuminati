 ...
 * @see edu.pojo.Coursestudentmap
 * @author Hibernate Tools
 */
public class CoursestudentmapHome {

    private static final Log log = LogFactory.getLog(CoursestudentmapHome.class);
    ...
    public Coursestudentmap findById( int id) {
        ...
        try {
            Coursestudentmap instance = (Coursestudentmap) sessionFactory.getCurrentSession()
                    .get("edu.pojo.Coursestudentmap", id);
            if (instance==null) {
    ...
    public List findByExample(Coursestudentmap instance) {
        ...
        try {
            List results = sessionFactory.getCurrentSession()
                    .createCriteria("edu.pojo.Coursestudentmap")
