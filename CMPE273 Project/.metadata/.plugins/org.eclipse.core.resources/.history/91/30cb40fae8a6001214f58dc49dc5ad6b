...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements Connections.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/UniversityManagement2/services/Service";
    ...
    public Connections.Service getService() throws javax.xml.rpc.ServiceException {
    ...
    public Connections.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Connections.ServiceSoapBindingStub _stub = new Connections.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Connections.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                Connections.ServiceSoapBindingStub _stub = new Connections.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://Connections", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://Connections", "Service"));
        }
